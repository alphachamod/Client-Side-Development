...
public class ProductAPI extends HttpServlet {
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Integer.parseInt(paras.get("p_id").toString()), 
		paras.get("p_name").toString(), 
		paras.get("innovator_name").toString(), 
		Integer.parseInt(paras.get("initial_price").toString()), 
		Integer.parseInt(paras.get("stock_amount").toString()), 
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		Map paras = getParasMap(request); 
		String output = ProductObj.deleteProduct(
				Integer.parseInt(paras.get("p_id").toString()); 
		response.getWriter().write(output); 
	}
